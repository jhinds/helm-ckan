...
beaker.session.secret = g7ePkfmJ7i1nQIdp5fTi8oqt3

# `paster make-config` generates a unique value for this each time it generates
# a config file.
app_instance_uuid = f0720268-8d2d-4725-9bf9-193214a58b37
...
ckan.views.default_views = image_view text_view recline_view pdf_view officedocs_view
